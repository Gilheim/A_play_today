...
class Play {
    ...
    static async createPlay(play){
        ...
        const query = 'INSERT INTO shows (show_name, show_description, ticket_price, end_date, genre, show_duration, poster_url, theatre_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *;'
    ...
    static async updatePlay(play, id) {
        ...
        const getTheatreId = await db.query('SELECT theatre_id FROM theatres WHERE theatre_name ILIKE $1;', [theatre_name])
        const theatre_id = getTheatreId.rows[0].theatre_id
        const query = 'UPDATE shows SET show_name = $1, show_description = $2, ticket_price = $3, end_date = $4, genre = $5, show_duration = $6, poster_url = $7, theatre_id = $8 WHERE show_id = $9 RETURNING *;'
